...
describe('getNextProvider', () => {
    it('should select provider based on their performance rank', () => {
      ...
      console.log("Request to rpc with a performance score of " + providers[0] + ": " + selections[0]);
      console.log("Request to rpc with a performance score of " + providers[1] + ": " + selections[1]);
      console.log("Request to rpc with a performance score of " + providers[2] + ": " + selections[2]);
